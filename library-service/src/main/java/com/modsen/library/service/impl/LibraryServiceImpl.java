...
import com.modsen.library.dto.mapper.DiaryMapper;
...
public class LibraryServiceImpl implements LibraryService {
    ...
    public Diary getAllBooks() {
        ...
        return diaryMapper.toDiary(bookList);
    ...
    public BookResponse getBookById(Long id) {
        ...
        Book book = bookRepository.findById(id).orElseThrow(com.modsen.library.exception.EntityNotFoundException::new);
    ...
    public BookResponse getBookByISBN(String ISBN) {
        ...
        Book book = bookRepository.findByISBN(ISBN).orElseThrow(com.modsen.library.exception.EntityNotFoundException::new);
        return bookMapper.toBookResponse(book);
    }
    ...
    public void updateBook(Long id, BookRequest bookRequest) {
        ...
        bookRepository.findById(id).orElseThrow(com.modsen.library.exception.EntityNotFoundException::new);
        Book book = bookMapper.toBook(bookRequest);
        book.setId(id);
        bookRepository.save(book);
    }
